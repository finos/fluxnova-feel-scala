 ...
 */
package org.flowave.feel.impl.interpreter

import org.flowave.feel.api.EvaluationFailureType
import org.flowave.feel.context.Context.{EmptyContext, StaticContext}
import org.flowave.feel.context.FunctionProvider.{
  CompositeFunctionProvider,
  EmptyFunctionProvider,
  StaticFunctionProvider
}
import org.flowave.feel.context.VariableProvider.{
  CompositeVariableProvider,
  EmptyVariableProvider,
  StaticVariableProvider
}
import org.flowave.feel.context.{Context, FunctionProvider, VariableProvider}
import org.flowave.feel.impl.interpreter.EvalContext.{
  mergeFunctionProviders,
  mergeVariableProvider,
  toSortedVariableProvider,
  wrap
}
import org.flowave.feel.syntaxtree.{Val, ValError, ValFunction}
import org.flowave.feel.valuemapper.ValueMapper
