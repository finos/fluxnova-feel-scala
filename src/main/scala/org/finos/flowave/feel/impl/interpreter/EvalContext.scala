 ...
 */
package org.finos.flowave.feel.impl.interpreter

import org.finos.flowave.feel.api.EvaluationFailureType
import org.finos.flowave.feel.context.Context.{EmptyContext, StaticContext}
import org.finos.flowave.feel.context.FunctionProvider.{
...
import org.finos.flowave.feel.context.{Context, FunctionProvider, VariableProvider}
import org.finos.flowave.feel.impl.interpreter.EvalContext.{
  mergeFunctionProviders,
  mergeVariableProvider,
  toSortedVariableProvider,
  wrap
}
import org.finos.flowave.feel.syntaxtree.{Val, ValError, ValFunction}
