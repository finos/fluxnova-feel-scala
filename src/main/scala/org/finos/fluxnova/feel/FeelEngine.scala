 ...
 */
package org.finos.fluxnova.feel
...
import org.finos.fluxnova.feel.api.{
  EvaluationFailure,
...
import org.finos.fluxnova.feel.context.{Context, FunctionProvider}
import org.finos.fluxnova.feel.impl.interpreter.{BuiltinFunctions, EvalContext, FeelInterpreter}
import org.finos.fluxnova.feel.impl.parser.{ExpressionValidator, FeelParser}
import org.finos.fluxnova.feel.syntaxtree.{Exp, ParsedExpression, ValError, ValFatalError}
import org.finos.fluxnova.feel.valuemapper.ValueMapper.CompositeValueMapper
import org.finos.fluxnova.feel.valuemapper.{CustomValueMapper, ValueMapper}
...
object FeelEngine {
  ...
  /** @deprecated
    *   Use [[org.finos.fluxnova.feel.api.FeelEngineBuilder]] instead.
    */
...
class FeelEngine(
  ...
  /** @deprecated
    *   Use [[org.finos.fluxnova.feel.api.FeelEngineApi]] instead.
    */
