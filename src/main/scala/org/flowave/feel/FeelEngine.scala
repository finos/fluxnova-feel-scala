 ...
 */
package org.flowave.feel

import fastparse.Parsed
import org.flowave.feel.FeelEngine.{
  Configuration,
  EvalExpressionResult,
  EvalUnaryTestsResult,
  Failure
}
import org.flowave.feel.api.{
  EvaluationFailure,
...
import org.flowave.feel.context.{Context, FunctionProvider}
import org.flowave.feel.impl.interpreter.{BuiltinFunctions, EvalContext, FeelInterpreter}
import org.flowave.feel.impl.parser.{ExpressionValidator, FeelParser}
import org.flowave.feel.syntaxtree.{Exp, ParsedExpression, ValError, ValFatalError}
import org.flowave.feel.valuemapper.ValueMapper.CompositeValueMapper
import org.flowave.feel.valuemapper.{CustomValueMapper, ValueMapper}
...
object FeelEngine {
  ...
  /** @deprecated
    *   Use [[org.flowave.feel.api.FeelEngineBuilder]] instead.
    */
...
class FeelEngine(
  ...
  /** @deprecated
    *   Use [[org.flowave.feel.api.FeelEngineApi]] instead.
    */
