 ...
 */
package org.finos.flowave.feel
...
import org.finos.flowave.feel.api.{
  EvaluationFailure,
...
import org.finos.flowave.feel.context.{Context, FunctionProvider}
import org.finos.flowave.feel.impl.interpreter.{BuiltinFunctions, EvalContext, FeelInterpreter}
import org.finos.flowave.feel.impl.parser.{ExpressionValidator, FeelParser}
import org.finos.flowave.feel.syntaxtree.{Exp, ParsedExpression, ValError, ValFatalError}
import org.finos.flowave.feel.valuemapper.ValueMapper.CompositeValueMapper
import org.finos.flowave.feel.valuemapper.{CustomValueMapper, ValueMapper}
...
object FeelEngine {
  ...
  /** @deprecated
    *   Use [[org.finos.flowave.feel.api.FeelEngineBuilder]] instead.
    */
...
class FeelEngine(
  ...
  /** @deprecated
    *   Use [[org.finos.flowave.feel.api.FeelEngineApi]] instead.
    */
